...
export class CustomCommandSettingsUI {
    ...
    render() {
        ...
        // Section description & Folder info combined
        const infoBox = this.containerEl.createDiv({ cls: 'ls-info-box' });
        ...
        const defaultBtn = actionsContainer.createEl('button', { text: '生成默认 (Generate Default)' });
        ...
        // Add command button
        const addBtn = actionsContainer.createEl('button', { text: '+ 添加命令 (Add Cmd)', cls: 'mod-cta' });
